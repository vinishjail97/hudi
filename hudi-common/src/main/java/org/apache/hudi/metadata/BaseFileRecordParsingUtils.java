...
public class BaseFileRecordParsingUtils {
  ...
  public static Iterator<HoodieRecord> generateRLIMetadataHoodieRecordsForBaseFile(String basePath,
    ...
    String fileId = ExternalFilePathUtil.isExternallyCreatedFile(latestFileName)
        ? ExternalFilePathUtil.parseFileIdAndCommitTimeFromExternalFile(latestFileName)[0]
        : FSUtils.getFileId(latestFileName);

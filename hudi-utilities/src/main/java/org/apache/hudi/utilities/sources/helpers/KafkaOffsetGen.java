...
public class KafkaOffsetGen {
  ...
  public static class CheckpointUtils {
    ...
    public static OffsetRange[] computeOffsetRanges(Map<TopicPartition, Long> fromOffsetMap,
      ...
      LOG.debug(String.format("numEvents %s, minPartitions %s", numEvents, minPartitions));
  ...
  public static class Config {
    ...
    public static final ConfigProperty<Long> KAFKA_SOURCE_MIN_PARTITIONS = ConfigProperty
        .key("hoodie.deltastreamer.source.kafka.minPartitions")
        .defaultValue(0L)
  ...
  public OffsetRange[] getNextOffsetRanges(Option<String> lastCheckpointStr, long sourceLimit, HoodieIngestionMetrics metrics) {
    ...
    long minPartitions = props.getLong(Config.KAFKA_SOURCE_MIN_PARTITIONS.key(),
        Config.KAFKA_SOURCE_MIN_PARTITIONS.defaultValue());
    LOG.info("getNextOffsetRanges set config " + Config.KAFKA_SOURCE_MIN_PARTITIONS.key() + " to " + minPartitions);

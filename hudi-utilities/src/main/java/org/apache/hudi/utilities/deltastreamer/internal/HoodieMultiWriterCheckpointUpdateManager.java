...
public class HoodieMultiWriterCheckpointUpdateManager implements HoodieWriteCommitCallback {
  ...
  public void updateCheckPointForMultiWriter(HoodieCommitMetadata metadata, TypedProperties props, Map<String,String> extraMetadata, Option<Pair<HoodieInstant, Map<String, String>>> lastCompletedTxnAndMetadata) {

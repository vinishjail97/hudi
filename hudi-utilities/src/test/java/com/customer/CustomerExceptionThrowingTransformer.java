...
/**
 * Used in testing to classify transformers as customer vs internal.
 */
public class CustomerExceptionThrowingTransformer implements Transformer {
  ...
  private static class ExceptionThrower implements MapFunction<Row, Row> {
    ...
    public Row call(Row value) {
      throw new RuntimeException("Failure in customer transformer");
    }
  }
}
